...
|---|---|---|
| **Claude Code** | `npm i -g @anthropic-ai/claude-code` | Shipwright: system-level work, fixing the vessel, debugging the orchestrator, hard problems |
| **Codex CLI** | `npm i -g @openai/codex` | Second shipwright / cross-check |
