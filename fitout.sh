...
for bin in charter sail muster unlock captain telescope pick-model cost-proxy pi-monitor purser-totals quartermaster bosun first-mate berth roster-note ship delegate-claude delegate-codex backend-watch; do
